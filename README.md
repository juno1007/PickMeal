...
| 포지션 | 이름 | 담당 업무 | Github |
|:---:|:---:|---|:---:|
| **팀장** | **강한수** | 프로젝트 총괄, 브랜치 병합 관리, 아키텍처 설계,  OAuth2 연동, 백엔드 개발 | [@dlive838-maker](https://github.com/dlive838-maker) |
...
| **팀원** | **황준호** | 월드컵 알고리즘 설계, DB 및 카카오맵 API 구축 | [@juno1007](https://github.com/juno1007) |
